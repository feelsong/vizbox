    ...
    function geoChart() {
        var directive = {
            ...
            link: function(scope, element, attrs) {
                ...
                var container = d3.select(element[0]).append('div').attr('class', '')

                var map = container.append("svg").attr({
                    "width": width,
                    "height": height
                });
                ...
                function tooltipShow(d, i) {
                    ...
                    if (!tooltip) {
                        tooltip = container.append('div').attr('class', 'tooltip-container')
                    }
                    tooltip.html('<table class="c3-tooltip tooltip"><tbody><tr><th colspan="2">State</th></tr><tr class=""><td class="name">' + stateName + '</td><td class="value">' + Math.random().toFixed(1) + '</td></tr></tbody></table>');
